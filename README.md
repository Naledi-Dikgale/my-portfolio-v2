...
### [Live Preview](https://naledi.netlify.app/)
...
```sh
  git clone https://github.com/Naledi-Dikgale/my-portfolio-v2.git
  cd My Portfolio-v2
```
...
### Deployment
Deployment [here](https://naledi.netlify.app/)
...
Feel free to check the [issues page](https://github.com/Naledi-Dikgale/my-portfolio-v2/issues).
...
* [@zerodegreecoder](https://www.youtube.com/@zerodegreecoder) for amazing tutorials.
